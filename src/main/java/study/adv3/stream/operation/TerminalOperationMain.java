...
public class TerminalOperationMain {
    ...
    static void main(String[] args) {
        List<Integer> numbers = List.of(1, 2, 2, 3, 4, 5, 6, 7, 8, 8, 9, 10);

        // Collectors 뒤에서 더 자세히 (복잡한 수집이 필요할 때 사용)
        System.out.println("1. collect - List 수정");
        ...
        long count = numbers.stream()
                .filter(n -> n > 5)
                .count();
        System.out.println("5보다 큰 순자 개수: " + count);
        System.out.println();
        ...
        Optional<Integer> sum1 = numbers.stream()
                .reduce((a, b) -> a + b);
        System.out.println("합계(초기화 값 없음) = " + sum1.get());
        System.out.println();

        System.out.println("초기값이 있는 reduce");
        Integer sum2 = numbers.stream()
                .reduce(100, (a, b) -> a + b);
        System.out.println("합계(초기화 값: 100) = " + sum2);
        System.out.println();
        ...
        System.out.println("12. allMatch - 모든 요소가 조건을 만족하는 지");
